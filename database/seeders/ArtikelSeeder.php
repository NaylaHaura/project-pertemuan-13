...
class ArtikelSeeder extends Seeder
{
    public function run(): void
    {
        DB::table('artikels')->insert([
            [
                'judul'      => 'Profil PT L\'Essential, Produsen Skincare dan Kosmetik Berstandar BPOM dan Halal',
            ...
            [
                ...
                'slug'       => 'kuatkan-bisnis-theraskin-luncurin-3-produk-skincare-iklim-tropis',
